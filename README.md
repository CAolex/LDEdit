...
![In the process of generating images from random noise, we establish connections between pixels in regions of interest in the synthesized image and latent codes, and utilize PCA to optimize latent codes and identify semantic directions related to specific diseases to guide image synthesis](https://github.com/CAolex/LDEdit/blob/main/images/flow.png)
